            ...
            <div id="sidebar-footer" className="mt-auto">
                <div id="footer-card" className="bg-hijau px-4 py-2 rounded-md shadow-lg mb-10 flex items-center">
                    <div id="footer-text" className="text-white text-sm">
                        ...
                        <div id="add-menu-button" className="flex justify-center items-center p-2 mt-3 bg-blue-400 rounded-md space-x-2">
                            <FaPlus className="mr-4 text-xl" />
                            <span className="text-white flex items-center">Add Menus</span>
                        </div>
                    </div>
                    <img id="footer-avatar" className="w-13 rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIe3VuOA6oMIqC9QIR6mkvfG9stciQXtOZ4A&s" />
                </div>
